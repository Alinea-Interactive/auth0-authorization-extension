...
/**
 * Create a new RDBMSRecordProvider.
 * @param {Object} storageContext The storage context.
 * @constructor
 */
function RDBMSRecordProvider(storageContext, options) {
 ...
 */
RDBMSRecordProvider.prototype.write = function(storageContext, action) {
 ...
 * @return {Object} The record.
 */
RDBMSRecordProvider.prototype.create = function(collectionName, record) {
 ...
 * @return {Object} The record.
 */
RDBMSRecordProvider.prototype.update = function(collectionName, identifier, record, upsert) {
  const storageContext = this.storageContext;
  return this.write(storageContext, function() {
    return getDataForCollection(storageContext, collectionName)
      .then(function(data) {
 ...
 * @param {string} identifier The identifier of the record to update.
 */
RDBMSRecordProvider.prototype.delete = function(collectionName, identifier) {
  const storageContext = this.storageContext;
  return this.write(storageContext, function() {
    return getDataForCollection(storageContext, collectionName)
      .then(function(data) {
 ...
 * @type {function}
 */
module.exports = RDBMSRecordProvider;
